...
describe('Bag Actions Tests', () => {
  ...
  describe('changeFanPower', () => {
    const tester = (expectedActions) => {
      ...
      return Promise.resolve(store.dispatch(bagActions.changeFanPower()))
        .then(() => {
          const actionsDispatched = _.map(store.getActions(), action => action.type);
          return expect(actionsDispatched).toEqual(expectedActions);
        });
    ...
    it('should create an object of the correct type', () => {
      // ARRANGE
      const expectedActions = [
        bagActionTypes.CHANGE_FAN_POWER,
      ];
  ...
  describe('changeLieCircles', () => {
    const tester = (expectedActions) => {
      ...
      return Promise.resolve(store.dispatch(bagActions.changeLieCircles()))
        .then(() => {
          const actionsDispatched = _.map(store.getActions(), action => action.type);
          return expect(actionsDispatched).toEqual(expectedActions);
        });
    ...
    it('should create an object of the correct type', () => {
      // ARRANGE
      const expectedActions = [
        bagActionTypes.CHANGE_LIE_CIRCLE,
      ];
  ...
  describe('changeLieDistance', () => {
    const tester = (expectedActions) => {
      ...
      return Promise.resolve(store.dispatch(bagActions.changeLieDistance()))
        .then(() => {
          const actionsDispatched = _.map(store.getActions(), action => action.type);
          return expect(actionsDispatched).toEqual(expectedActions);
        });
    ...
    it('should create an object of the correct type', () => {
      // ARRANGE
      const expectedActions = [
        bagActionTypes.CHANGE_LIE_DISTANCE,
      ];
  ...
  describe('changePaths', () => {
    const tester = (expectedActions) => {
      ...
      return Promise.resolve(store.dispatch(bagActions.changePaths()))
        .then(() => {
          const actionsDispatched = _.map(store.getActions(), action => action.type);
          return expect(actionsDispatched).toEqual(expectedActions);
        });
  ...
  describe('changeThrowerPower', () => {
    const tester = (expectedActions) => {
      ...
      return Promise.resolve(store.dispatch(bagActions.changeThrowerPower()))
        .then(() => {
          const actionsDispatched = _.map(store.getActions(), action => action.type);
          return expect(actionsDispatched).toEqual(expectedActions);
        });
    ...
    it('should create an object of the correct type', () => {
      // ARRANGE
      const expectedActions = [
        bagActionTypes.CHANGE_THROWER_POWER,
      ];
  ...
  describe('changeThrowerType', () => {
    const tester = (expectedActions) => {
      ...
      return Promise.resolve(store.dispatch(bagActions.changeThrowerType()))
        .then(() => {
          const actionsDispatched = _.map(store.getActions(), action => action.type);
          return expect(actionsDispatched).toEqual(expectedActions);
        });
    ...
    it('should create an object of the correct type', () => {
      // ARRANGE
      const expectedActions = [
        bagActionTypes.CHANGE_THROWER_TYPE,
      ];
